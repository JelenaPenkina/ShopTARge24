...
namespace ShopTARge24.Controllers
{
    public class AccuWeathersController : Controller
    {
        ...
        public AccuWeathersController (IWeatherForecastServices weatherForecastServices)
        {
        ...
        public IActionResult City(string city) 
        {
           ...
           /* _weatherForecastServices.AccuWeatherResult(dto);*/ // HttpClient kasutatakse selle jaoks
