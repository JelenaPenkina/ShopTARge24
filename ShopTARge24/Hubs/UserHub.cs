...
namespace ShopTARge24.Hubs
{
    public class UserHub : Hub
    {
        ...
        public async Task<string> NewWindowLoaded(string name)
        {
            ...
            // add-client libary @microsoft/signalr@latest, provider "unpkg" if not working then "jsdelivr" 
            // vaadata tema repository üle https://github.com/bhrugen?tab=repositories
        }
    }
}
